...
<div class="container mt-5">
	...
	<a href="petugas.php" class="btn btn-dark"> Petugas</a>
	<a href="petugas.php?url=pembayaran" class="btn btn-dark"> Pembayaran</a>
	<a href="petugas.php?url=logout" class="btn btn-dark"> Logout</a>
