		...
		<tr>
			...
			<td>
				...
				if ($kekurangan==0) {
					...
					<a href="?url=tambah-pembayaran&nisn=<?= $data['nisn'] ?>&kekurangan=<?= $kekurangan?>"class="btn btn-success">Pilih dan Bayar</a>
				<?php }?>
			</td>
			<td>
				<a href="?url=history-pembayaran&nisn=<?= $data['nisn'] ?>" class='btn btn-dark'>History</a>
			</td>
		</tr>
	<?php } ?>
