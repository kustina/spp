...
<html lang="en">
  <head>
  	<title>Aplikasi Siswa - Aplikasi Pembayaran SPP</title>
    <meta charset="utf-8">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">LOGIN SISWA</h2>
				</div>
			</div>
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
	            	<label>NIS</label>
	              <input  type="password" name="nis" class="form-control" placeholder="Masukan NIS anda.." required>
	            </div>
	            <div class="form-group">
