...
<body>
	<div class="container mt-5">
		...
		<a href="siswa.php" 				class="btn btn-dark"> Siswa </a>
		<a href="siswa.php?url=logout" 		class="btn btn-dark"> Logout </a>
		...
		<div class="card mt-3">
			<div class="card-body">
				...
				if (empty($file)){
					...
					echo "Aplikasi Pembayaran SPP digunakan untuk mempermudah dalam mencatat pembayaran siswa disekolah";
					echo"<hr>";
